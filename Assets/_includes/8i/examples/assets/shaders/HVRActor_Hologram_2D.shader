Shader "8i/Example/HVRActor_Hologram_2D"
{
    Properties
    {
        ...
        _RimPower("Rim Power", Range(0.0, 2.0)) = 0.0
        _ScanLines("Scan lines", Int) = 300
    ...
    Output frag_hologram(v2f i)
    {
        ...
        // Scanlines
        half scanline = abs(sin(screenPos.x * _ScanLines)); // Screenspace Scanlines
